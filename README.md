...
<img src="icons/youtube-wav-downloader.png" width="128" height="128" alt="Iconița aplicației: o pisică cu ochi ușor încrucișați">
...
├── icons/             # iconița aplicației (icons/youtube-wav-downloader.png)
...
├── icons/             # the app icon (icons/youtube-wav-downloader.png)
└── README.md          # this file
```
